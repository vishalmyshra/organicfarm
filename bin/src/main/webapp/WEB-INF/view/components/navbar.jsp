...
<div class="container-fluid">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    %>
      ...
      <li class="nav-item active dropdown text-color ml-2">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
         <b style="color:white;">Crops</b>
        </a>
        <div class="dropdown-menu " aria-labelledby="navbarDropdown">
          <a class="dropdown-item " href="onion"><b class="text-color">Onion</b></a>
          <a class="dropdown-item " href="sugarcane"><b class="text-color">Sugarcane</b></a>
           <a class="dropdown-item " href="tur"><b class="text-color">Tur</b></a>
        </div> 
      </li> 
    ...
    %>
      ...
      <li class="nav-item active text-color">
        <a class="nav-link" href="userregister"><b style="color:white;">Register</b></a>
      </li>  
